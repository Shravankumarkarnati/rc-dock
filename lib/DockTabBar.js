...
const DockTabBar = (props) => {
    ...
    const { navigateToPanel } = DockData_1.useDockContext();
    ...
    return (React.createElement(DragDropDiv_1.DragDropDiv, { onDragStartT: onDragStart, onDragMoveT: onDragMove, onDragEndT: onDragEnd, role: "tablist", className: "dock-bar", onKeyDown: onKeyDown, getRef: setRef, tabIndex: -1 },

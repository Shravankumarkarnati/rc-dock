...
const DockDropEdge = ({ panelData, panelElement, dropFromPanel }) => {
    const { getDockId, getGroup, setDropRect, dockMove } = (0, DockData_1.useDockContext)();
    ...
    (e) => setDropRect(null, "remove", this), [setDropRect]);
    ...
    }, [panelData, dropFromPanel, getDockId, getGroup, dockMove, getDirection, getActualDepth]);
    return (React.createElement(DragDropDiv_1.DragDropDiv, { getRef: setRef, className: "dock-drop-edge", onDragOverT: onDragOver, onDragLeaveT: onDragLeave, onDropT: onDrop }));
};

...
exports.DividerBox = React.memo(function DividerBoxBase(props) {
    ...
    if (Array.isArray(children)) {
        for (let i = 0; i < children.length; ++i) {
            if (i > 0) {
                childrenRender.push(React.createElement(Divider_1.Divider, { idx: i, key: i, isVertical: isVertical, getDividerData: getDividerData, changeSizes: changeSizes }));
            }

...
exports.DockTabs = React.memo(function DockTabBase(props) {
    ...
    return (React.createElement(rc_tabs_1.default, { prefixCls: "dock", more: { icon: moreIcon }, 
        // TODO: make animation work
        animated: { inkBar: animated, tabPane: tabPaneAnimated }, renderTabBar: renderTabBar, activeKey: activeId, onChange: onTabChange, popupClassName: classnames_1.default(Utils_1.groupClassNames(group)), items: items }));
});

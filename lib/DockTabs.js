...
class TabCache {
    ...
    render() {
        ...
        const label = (React.createElement(DragDropDiv_1.DragDropDiv, { getRef: this.getRef, onDragStartT: onDragStart, role: "tab", "aria-selected": parent.activeId === id, onDragOverT: onDragOver, onDropT: onDrop, onDragLeaveT: onDragLeave },
            title,
        ...
        const _content = (React.createElement(DockTabPane_1.default, { key: id, cacheId: id, cached: cached, tab: label }, content));
...
exports.DockTabs = React.memo(function DockTabBase(props) {
    ...
    const renderTabBar = React.useCallback((props, TabNavList) => {
        ...
        const showNewWindowButton = newWindow && WindowBox_1.isWindowBoxEnabled() && parent.mode === "float";
        ...
        return (React.createElement(DockTabBar_1.DockTabBar, Object.assign({ onDragStart: onPanelDragStart, onDragMove: onPanelDragMove, onDragEnd: onPanelDragEnd, TabNavList: TabNavList, isMaximized: parent.mode === "maximize" }, props, { extra: panelExtraContent })));
    }, [
        panelData,
        tabGroup,
        onPanelDragStart,

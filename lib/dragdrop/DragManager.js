...
exports.addDragStateListener = exports.destroyDraggingElement = exports.removeHandlers = exports.addHandlers = exports.isDragging = exports.DragState = void 0;
...
function createDraggingElement(state, refElement, draggingHtml) {
    ...
    if (draggingHtml) {
        ...
        if (window.getComputedStyle(_draggingDiv.firstElementChild).backgroundColor === "rgba(0, 0, 0, 0)") {
            ;
            _draggingDiv.firstElementChild.style.backgroundColor = window

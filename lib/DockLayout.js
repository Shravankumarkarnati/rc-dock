...
const DroppingPanel_1 = require("./DroppingPanel");
...
const DockLayoutBase = React.forwardRef(function _DockLayout(props, ref) {
    ...
    }, [getLayout, find, state.dropRect, _ref, groups, changeLayout]);
    ...
    React.useEffect(() => {
        var _a;
        const _onWindowResize = debounce_1.default(() => {
            let layout = getLayout();
            if (_ref) {
    ...
    React.useEffect(() => {
        const onDragStateChange = (draggingScope) => {
            if (draggingScope == null) {
                DroppingPanel_1.DroppingPanel.droppingPanel = null;
                if (state.dropRect) {
                    setState((prev) => (Object.assign(Object.assign({}, prev), { dropRect: null })));
                }
            }
    ...
    return (React.createElement("div", { ref: setRef, className: "dock-layout", style: style },
        React.createElement(DockData_1.DockContextProvider, { value: value },
...
exports.DockLayout = React.memo(DockLayoutBase);

...
const DockLayout = ({ afterPanelLoaded, afterPanelSaved, defaultLayout, dockId, dropMode, groups, layout, loadTab, maximizeTo, onLayoutChange, saveTab, style, }) => {
    ...
    React.useEffect(() => {
        const onWindowResize = (0, debounce_1.default)(() => {
            let layout = state.layout;
            if (ref) {
    ...
    React.useEffect(() => {
        const unSubscribe = (0, DragManager_1.addDragStateListener)(onDragStateChange);
        return unSubscribe;
    }, [onDragStateChange]);
    React.useEffect(() => {
        var _a;
    ...
    if (maximizeTo) {
        ...
        maxBox = ReactDOM.createPortal(React.createElement(MaxBox_1.MaxBox, { boxData: state.layout.maxbox }), maximizeTo);
    }
    else {
        maxBox = React.createElement(MaxBox_1.MaxBox, { boxData: state.layout.maxbox });
    }
    return (React.createElement("div", { ref: setRef, className: "dock-layout", style: style },
        React.createElement(DockPortalManager_1.DockPortalManager, null,
            React.createElement(DockData_1.DockContextProvider, { value: context },
                React.createElement(DockBox_1.DockBox, { size: 1, boxData: state.layout.dockbox }),
                React.createElement(FloatBox_1.FloatBox, { boxData: state.layout.floatbox }),
                React.createElement(WindowBox_1.WindowBox, { boxData: state.layout.windowbox }),
                maxBox,
                React.createElement(DockPortalManager_1.RenderDockPortals, null))),

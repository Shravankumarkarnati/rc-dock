...
const DockLayout = ({ afterPanelLoaded, afterPanelSaved, defaultLayout, dockId, dropMode, groups, layout, loadTab, maximizeTo, onLayoutChange, saveTab, style, }) => {
    ...
    if (maximizeTo) {
        ...
        maximize = ReactDOM.createPortal(React.createElement(MaxBox_1.MaxBox, { boxData: state.layout.maxbox }), maximizeTo);
    }
    else {
        maximize = React.createElement(MaxBox_1.MaxBox, { boxData: state.layout.maxbox });
    }

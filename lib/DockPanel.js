...
exports.DockPanel = React.memo(function DockPanelBase(props) {
    ...
    const onDragOver = React.useCallback((e) => {
        if (DroppingPanel_1.DroppingPanel._droppingPanel === droppingPanelState) {
            return;
        }
        let tab = DragManager_1.DragState.getData("tab", dockId);
        let panel = DragManager_1.DragState.getData("panel", dockId);
        if (tab || panel) {
            DroppingPanel_1.DroppingPanel.droppingPanel = droppingPanelState;
        }
        if (tab) {
            if (tab.parent) {
    ...
    const onPanelHeaderDragStart = React.useCallback((event) => {
        ...
        if ((parent === null || parent === void 0 ? void 0 : parent.mode) === "float") {
            ...
            let [panelWidth, panelHeight] = Algorithm_1.getFloatPanelSize(_ref, tabGroup);
            event.setData({
                panel: panelData,
    ...
    if (dropFromPanel) {
        ...
        if (!dropFromGroup.tabLocked || DragManager_1.DragState.getData("tab", dockId) == null) {
            ...
            let DockDropClass = context.useEdgeDrop() ? DockDropEdge_1.DockDropEdge : DockDropLayer_1.DockDropLayer;
    ...
    return (React.createElement(DragDropDiv_1.DragDropDiv, { getRef: setRef, className: cls, style: style, "data-dockid": id, onDragOverT: isFloat ? null : onDragOver, onClick: onPanelClicked },
        React.createElement(DockTabs_1.DockTabs, { panelData: panelData, onPanelDragStart: _onPanelHeaderDragStart, onPanelDragMove: onPanelHeaderDragMove, onPanelDragEnd: onPanelHeaderDragEnd }),
        isFloat
            ? [

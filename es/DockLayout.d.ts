...
import { DockContext, DropDirection, LayoutBase, LayoutData, PanelBase, PanelData, TabBase, TabData, TabGroup } from "./DockData";
...
declare type DockRef = {
    saveLayout(): LayoutBase;
    loadLayout(savedLayout: LayoutBase): void;
} & Pick<DockContext, "dockMove" | "find" | "updateTab">;
export declare const DockLayout: React.MemoExoticComponent<React.ForwardRefExoticComponent<LayoutProps & React.RefAttributes<DockRef>>>;
export {};

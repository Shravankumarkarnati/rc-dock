...
let defaultTab = {
  title: "default-style",
  content: (
    <div>Tabs from different style group can't be docked in same panel</div>
  ),
};
let headlessTab = {
  title: "headless",
        ...
        children: [
          {
            tabs: [
              { ...defaultTab, id: "t7" },
              {
                ...
                content: <div>Tab title can be any react component</div>,
              },
              jsxTab,
              htmlTab,
            ],

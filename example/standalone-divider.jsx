...
class Demo extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        Divider can be used separately, this doesn't require anything else from
        the dock layout package
        ...
        Dragging with shift key to resize all children, otherwise only 2
